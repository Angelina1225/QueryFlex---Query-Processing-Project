...
def query():
    query = {'S': ['cust', 'prod', 'wkend_sum_quant', 'wkday_sum_quant'], 'n': 2, 'V': ['cust', 'prod'], 'F-VECT': [{'name': 'wkend_sum_quant', 'group_var': 'wkend', 'agg': 'sum', 'attribute': 'quant'}, {'name': 'wkday_sum_quant', 'group_var': 'wkday', 'agg': 'sum', 'attribute': 'quant'}], 'SUCH-THAT': {'var1': {'group_var': 'wkend', 'attribute': 'day', 'value': [6, 7]}, 'var2': {'group_var': 'wkday', 'attribute': 'day', 'value': [1, 2, 3, 4, 5]}}, 'HAVING': {}}
